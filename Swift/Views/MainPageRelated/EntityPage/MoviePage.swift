            ...
            ScrollViewReader { proxy in
                            ...
                            VStack {
                                HStack(alignment: .top){
                                    VStack(alignment: .center){
                                        ...
                                        Text("\(String(movie.releaseYear)) • Directed by")
                                            .font(.system(size: 14, weight: .light))
                                            .padding(.top, 20)
                                        
                                        Text(movie.director)
                                        
                                        Text("\(movie.category) • \(movie.runtime) Minutes")
                                            .font(.system(size: 14, weight: .light))
                                            .padding(.top, 5)
                                            .minimumScaleFactor(0.75)
                                        
                                        Text(movie.country.components(separatedBy: ",").first ?? "")
                                            .font(.system(size: 14, weight: .light))
                                            .padding(.top, 3)
                                        
                                        if vM.user != nil {
                                            HStack { 
                                                if vM.user!.alreadyWatchedIds.contains(movie.id) {
                                                    Button {
                                                        vM.removeAlreadyWatched(id: movie.id)
                                                    } label: {
                                                        VStack {
                                                    ...
                                                    Button {
                                                        vM.addAlreadyWatched(id: movie.id)
                                                    } label: {
                                                        VStack {
                                                ...
                                                if vM.user!.watchLaterIds.contains(movie.id) {
                                                    Button {
                                                        vM.removeWatchLater(id: movie.id)
                                                    } label: {
                                                        VStack {
                                                            Image(systemName: "checkmark")
                                                                .font(.system(size: 20, weight: .bold))
                                                ...
                                                if movie.comments.map( {$0.senderId} ).contains(vM.user!.id) {
                                                    Button {
                                ...
                                VStack{
                                    ForEach(movie.actors.split(separator: ",").map { $0.trimmingCharacters(in: .whitespacesAndNewlines) }, id: \.self) { actor in
                                        HStack {
                                            Text(actor)
                                ...
                                HStack {
                                    ...
                                    if movie.avgRating != 0 {
                                        ForEach(0..<5, id: \.self) { index in
                                            ...
                                            if fullStarRating <= movie.avgRating {
                                                Image(systemName: "star.fill")
                                                    .foregroundColor(.yellow)
                                                
                                            } else if fullStarRating - 0.5 <= movie.avgRating {
                                    ...
                                    ForEach(movie.comments, id: \.self) { comment in
                                        ...
                                        .contextMenu {
                                            if vM.user != nil && comment.senderId == vM.user!.id {
                                                Button {
                                                    vM.removeComment(name: movie.name)
                                                } label: {
                                                    HStack {
                                                        Text("Remove")
                ...
                .toolbar {
                    ...
                    ToolbarItem(placement: .navigationBarTrailing) {
                        if vM.user != nil {
                            if vM.user!.ratings.map( {$0.entityName} ).contains(movie.name) {
                                Button {
                                    vM.unrate(id: movie.id)
                                } label: {
                                    Image(systemName: "star.fill")
                                }
        ...
        VStack {
            ...
            HStack {
                TextField("Write a comment...", text: $vM.commentText, axis: .vertical)
                    ...
                    .submitLabel(.send)
                    .onSubmit {
                        vM.sendComment(name: movie.name)
                    }
...
#Preview {
    MoviePage(vM: BindingPageViewModel(), movie: .constant(
        Movie(
            id: "",
            name: "Test Movie",
            releaseYear: 2015,
            ...
            actors: "",
            description: "A loooong loooong looooooong and really longgggggggg movie description, believe me.",
            country: "",
            awards: "",
            posterURL: "",
            imdb: 8.4,
